Config                            = {}
Config.Locale = 'bg' -- your language, It would be nice if you send me your translation on fivem forum
...
Config.SellPooch = false -- if true, players can sell pooch like weed_pooch, meth_pooch
...
Config.MethPrice = 120	-- sell price for single, not pooch (black money)
Config.CokePrice = 180	-- sell price for single, not pooch (black money)
Config.OpiuPrice = 80	-- sell price for single, not pooch (black money)
Config.DistanceFromCity = 6800 -- set distance that player cant sell drugs too far from city
