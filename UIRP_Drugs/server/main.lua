...
AddEventHandler('sellDrugs', function()
	...
	local cokeqty = xPlayer.getInventoryItem('cocaine').count
	local cokeqtySingle = xPlayer.getInventoryItem('cocaine').count
	local opiuqty = xPlayer.getInventoryItem('opium').count
...
AddEventHandler('drugsInProgress', function(street1, street2, sex)
      TriggerClientEvent("outlawNotify", -1, "~r~Продават ми наркотици ~w~близо до ~g~"..street1.."~w~ и ~g~"..street2)
...
AddEventHandler('drugsInProgressS1', function(street1, sex)
      TriggerClientEvent("outlawNotify", -1, "~r~Лродават ми наркотици ~w~близо до ~g~"..street1)
