...
Citizen.CreateThread(function()
	...
	ESX.TriggerServerCallback('UIRP_Pinlock:getDoorInfo', function(doorInfo, count)
		...
		if distance < maxDistance then
			for i=1, #doorID.authorizedCodes do
				if doorID.authorizedCodes[i] == code then
					...
					TriggerServerEvent('UIRP_Pinlock:updateState', i, doorID.locked) -- Broadcast new state of the door to everyone
				end
			end
...
RegisterNetEvent('UIRP_Pinlock:setState')
AddEventHandler('UIRP_Pinlock:setState', function(doorID, state)
